...
GITHUB_EXE_URL = (
    "https://github.com/Saetron/RegVapor/releases/latest/download/RegVapor.exe"
)
GITHUB_UPDATER_URL = (
    "https://github.com/Saetron/RegVapor/releases/latest/download/RegVapor_updater.exe"
)
